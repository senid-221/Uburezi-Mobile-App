...
export const lessons: Lesson[] = [
  {
    id: 'math-counting-1',
    title: 'Kwitoza kubara',
    subject: 'Imibare',
    duration: '15 min',
    icon: 'calculator-outline',
    summary: 'Wiga kubara no gukoresha imibare mu buryo bworoshye.',
    steps: [
  ...
  },
  {
    ...
    duration: '18 min',
    icon: 'leaf-outline',
    summary: 'Menya icyo ibimera bikenera kugira ngo bikure neza.',
    steps: [
  ...
  {
    id: 'ict-computer-1',
    title: 'Muri internet ni iki?',
    subject: 'Ikoranabuhanga',
    duration: '15 min',
    icon: 'laptop-outline',
    summary: 'Menya igitekerezo cy’ibanze cy’uko internet idufasha guhanahana amakuru.',
    steps: [
  ...
  },
  {
    ...
    summary: 'Witoza gusoma interuro ngufi no kumva icyo zivuga.',
    steps: [
