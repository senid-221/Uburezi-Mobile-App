...
const items = [
  ...
  { icon: 'book-outline' as const, title: 'Imyigire', text: 'Reba amasomo n’aho umwana ageze.', action: 'none' },
  { icon: 'time-outline' as const, title: 'Igihe', text: 'Genzura igihe porogaramu ikoreshwa.', action: 'none' },
  { icon: 'shield-checkmark-outline' as const, title: 'Umutekano', text: 'Genzura ibyo umwana yemerewe kubona.', action: 'none' },
];

export default function ParentDashboardScreen({ onBack, parent, onLogin, onChildren }: { onBack: () => void; parent: ParentAccount | null; onLogin: () => void; onChildren: () => void }) {
