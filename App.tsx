...
import type { ParentAccount } from './src/types/models';
...
export default function App() {
  ...
  if (screen === 'detail') return <Shell><LessonDetailScreen lessonId={lessonId} onBack={() => setScreen('lessons')} onStartQuiz={() => setScreen('quiz')} /></Shell>;
  if (screen === 'quiz') return <Shell><QuizScreen lessonId={lessonId} onBack={() => setScreen('lessons')} /></Shell>;
  ...
  if (screen === 'children') return <Shell><ChildProfileScreen parentId={parent?.id ?? ''} onBack={() => setScreen('parent')} /></Shell>;
    ...
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          ...
          <TouchableOpacity onPress={openParent} style={styles.avatar} activeOpacity={0.8}><Ionicons name="person" size={24} color="#2563EB" /></TouchableOpacity>
        </View>
